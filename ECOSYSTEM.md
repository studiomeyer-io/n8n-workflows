...
|---------|-------------|---------|
| **[n8n-workflows](https://github.com/studiomeyer-io/n8n-workflows)** *(this repo)* | Production n8n workflows with hardened patterns. No memory required. 15 templates: CRM router, Stripe, uptime, SSL, Slack digest, Calendly, GitHub issues, RSS, calendar conflicts, CSV validator, Email-Notion, Postgres-Sheets, webhook audit trail, Telegram translator, YouTube-Notion. | clone + import |
